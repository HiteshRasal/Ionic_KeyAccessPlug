                                                    ...
                                                    error:(BDError *)error
{
    ...
    [keyPairAttributes setObject:[NSNumber numberWithInt:2048] forKey:(__bridge id)kSecAttrKeySizeInBits];
...
{
    NSString * identifier  =[NSString stringWithFormat: @"-----BEGIN PUBLIC KEY-----  fsfsfsfsfsf  -----END PUBLIC KEY-----"];
...
{NSString *identifier =[NSString stringWithFormat:@"-----BEGIN PRIVATE KEY-----  fsfsfsfsffs -----END PRIVATE KEY-----"];
